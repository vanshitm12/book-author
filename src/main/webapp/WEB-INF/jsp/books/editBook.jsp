...
<div class="container py-5">
    <div class="card shadow-lg border-0">
        <div class="card-body p-4 p-md-5">
            ...
            <form action="/books/update/${book.id}" method="post" class="row g-3">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <select name="authorId" class="form-select">
                        <option value="">-- Keep/Create Author --</option>
                        <c:forEach var="author" items="${authors}">
                            <option value="${author.id}" ${book.author.id == author.id ? 'selected' : ''}>${author.name} (${author.email})</option>
                        </c:forEach>
                    </select>
                </div>

                <div class="col-12">
                    <h5 class="mt-3">Optional New Author Details (used only when no author selected)</h5>
                </div>
                <div class="col-md-4">
